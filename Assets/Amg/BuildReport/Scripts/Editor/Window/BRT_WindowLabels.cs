...
public static class Labels
{
	...
	public const string USED_TOTAL_SIZE_DESC = "Total size of the used assets before being packed.\nAlso includes size of compiled Mono scripts.\nDoes not include size of files in StreamingAssets.";
	public const string STREAMING_ASSETS_SIZE_DESC = "Total size of all files in the StreamingAssets folder.";


	public const string BUILD_SIZE_STANDALONE_DESC = "File size of the executable file and the accompanying Data folder.";
	...
	public const string BUILD_SIZE_LINUX_UNIVERSAL_DESC = "File size of both 32-bit and 64-bit executables, plus the accompanying Data folder.";
	...
	public const string FILTER_GROUP_TO_USE_EMBEDDED_LABEL = "Use file filter group embedded in file if available\n(when opening build report files)";
